...
public class GameModel  {
	...
	/**
	 * this is the time bonus the player gets for hitting each disk
	 */
	...
	/**
	 * increments timeRemaining by timeAdded each time a disk hits a target
	 */
	public void bonusTime(){
		gameLength = gameLength + timeAdded;
	}
